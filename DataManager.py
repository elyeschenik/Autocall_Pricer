...
class DataManager:
    ...
    def __init__(self):
        ...
        df_underlyings = pd.read_excel("Exam Data.xlsm", index_col=0, sheet_name="Histo underlying")
        ...
        df_call_put = pd.read_excel("Exam Data.xlsm", index_col=1, sheet_name="Call-Put Price").drop("CALL",
                                                                                                     axis=1).dropna()
